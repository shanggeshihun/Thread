...
rwf=ReadWriteFile(r'D:\learn\software_learn\NOTE\Python\Thread\9ht\write_info.txt')
...
class SubpageThread(threading.Thread):
    ...
    def get_subpage_url(self,res):
        ...
        app_info_url_list=html.xpath(r'//ul[@class="clearfix"]/li/p/a/@href')
        app_info_url_list=['http://www.9ht.com'+ u for u in app_info_url_list]
...
def main():
    ...
    rwf.clear_content()
    # 下载APP保存路径
    save_path=r'D:\learn\software_learn\NOTE\Python\Thread\9ht\app'
    ...
    # 主页面>>二级页面
    for i in range(2,11):
        main_url_queue.put('http://www.9ht.com/soft/qklzq/{}/'.format(i))
    main_thread_name_list=['main_thread_'+str(i) for i in range(1,10)]
    main_thread_list=[]
